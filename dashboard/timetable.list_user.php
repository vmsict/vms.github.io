...
if($_SESSION['user_id']){	
    ...
    function timetablelist($user_id){
		...
		$query = $link->query("SELECT * FROM timetable");
			  ...
			  "<table class='table'>".
				...
				while($result = $query->fetch()){
				  echo "<tr>"
						 ...
						 ."<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='../view.table_user.php?view=true&id=".$result['timetable_id']."&year=".$result['year']."&semester=".$result['semester']."&coursecode=".$result['course']."&coursefullname=".$result['course_full_name']."'><span class='glyphicon glyphicon-search'></span></a></td>"
						 ."</tr>".
				  "</tr>";
				}  
		echo	"</tbody>".
