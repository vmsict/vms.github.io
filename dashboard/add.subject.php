    ...
    <div class="col-lg-6">
		<div class="jumbotron">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-8">
				  <input id="l" name="l" type="text" placeholder="Lecture" class="form-control input-md" required="">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-8">
				  <input id="t" name="t" type="text" placeholder="Tutorial" class="form-control input-md" required="">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="p">Total CreditHour</label>  
				  <div class="col-md-8">
				  <input id="p" name="p" type="text" placeholder="Credithour" class="form-control input-md" required="">
				  <span class="help-block">Total Credithour for this subject</span>  
				  </div>
				</div>
