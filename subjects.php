		   ...
		   if($_SESSION['user_id'])
			{
			   $query = $link->query("
					...
					FROM course c JOIN faculty f ON c.faculty_id =f.faculty_id JOIN subject s ON s.subject_id =c.subject_id WHERE c.course_name =  '$course_code' OR c.semester ='$semester' AND c.user_id='$user_id'");
